# 🚗 Real-Time Number Plate Recognition by JST 🚓
Welcome to the Real-Time Number Plate Recognition project by JST! This project utilizes advanced technologies for efficient and accurate number plate detection and recognition in real-time.

# 🌟 Project Pipeline
<p align="center">
    <img src="https://github.com/MGJillaniMughal/Real-Time-Number-Plate-Recognition-by-JST/blob/main/pipeline.jpg" alt="Project pipeline">
</p>

# 🚀 Execution

# 🛠️ Setting Up Producer
